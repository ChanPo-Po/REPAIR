/* POPOPHONE Repair V8.2 - Google Apps Script API
Schema 10 bảng mới: DATA, CT_DICH_VU, CT_VAT_TU, DM_TRANG_THAI, DM_DICH_VU, DM_VAT_TU, DM_LOAI_DICH_VU, DM_KY_THUAT, DM_NCC, LOG_SUA_CHUA.
...
function addService(id,d){
  ...
  getSheet(SHEET_CT_DICH_VU).appendRow([id,name,price,d.note||'',d.user||'',now]);
