...
const ROLE_PERMISSIONS = {
  sale: ["createRepair"],
  tech: ["createRepair", "searchRepair", "getRepair", "updateTech", "addService", "deleteService", "getMasterData"],
  store_manager: ["searchRepair", "getRepair", "getDashboard", "getMasterData"],
  tech_manager: ["searchRepair", "getRepair", "updateTech", "addService", "deleteService", "addMaterial", "deleteMaterial", "updateMoney", "getDashboard", "getMasterData"],
  admin: ["createRepair", "searchRepair", "getRepair", "updateTech", "addService", "deleteService", "addMaterial", "deleteMaterial", "updateMoney", "getDashboard", "getMasterData"]
};

function doGet() {
  return json({ ok: true, message: "POPOPHONE Repair API V4 Final đang chạy", time: new Date() });
}
...
function getMasterData() {
  return {
    ...
    data: {
      ...
      branches: [{ name: "113" }, { name: "148" }, { name: "1/48" }],
      suppliers: [
        { name: "Thắng" },
        { name: "Vtech" },
        { name: "Hồ Chí Trung" },
