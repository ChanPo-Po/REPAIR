...
function setupNavByRole() {
  const allowed = {
    ...
    tech_manager: ['overview', 'repairs', 'status', 'cost', 'materials', 'commission', 'weeklyReport'],
    admin: ['overview', 'repairs', 'status', 'cost', 'materials', 'commission', 'weeklyReport', 'masters']
  }[USER.role] || [];
